      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">今日入账总额</div>
        ...
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">昨日入账总额</div>
            <div class="total-value">￥5000.00</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">近7天入账总额</div>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <div class="out-border">
            <div class="layout-title">书籍总览</div>
            <div style="padding: 40px">
              ...
              <el-row class="font-medium">
                ...
                <el-col :span="6" class="overview-item-title">全部书籍</el-col>
              </el-row>
            </div>
          </div>
        </el-col>
